...
public enum SpecSecuritySchemeType: Equatable {
    ...
    case apiKey(name: String, in: SpecSecurityAPIKeyLocation)

    /// OAuth 2.0.
    /// - `flows`: configuration of the supported OAuth Flows.
    case oauth2(flows: SpecOAuthFlows)
    ...
    case http(scheme: SpecSecurityHTTPScheme)
