...
internal struct SpecExtensionsContainer: Codable {
...
extension SpecExtensionsContainer: Equatable {

    // MARK: - Type Methods

    internal static func == (lhs: SpecExtensionsContainer, rhs: SpecExtensionsContainer) -> Bool {
